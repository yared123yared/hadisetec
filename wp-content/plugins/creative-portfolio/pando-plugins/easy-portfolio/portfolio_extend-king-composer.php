...
if ( is_plugin_active( 'kingcomposer/kingcomposer.php' ) ){
  add_action('init', 'pgfolio_portfolio_kingc_map_init', 99 );
}

function pgfolio_portfolio_kingc_map_init(){
...
$kc->add_map( 
   array(
      'pugfolio' => array(
         'name' => 'Portfolio Grid (Pugfolio)',
         'description' => 'Displays your Portfolio Projects',
         'category' => 'Pugfolio',
         'admin_view' => 'pgfolio_kingc_portfolio',
         //'icon' => 'bkci-portfolio',             
         'params' => array(
            array(
              'name' => 'postsperpage',
